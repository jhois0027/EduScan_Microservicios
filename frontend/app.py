            ...
            <div class="grid">
                ...
                <div class="card">
                    ...
                    <div class="endpoint">
                        ...
                        <div class="endpoint-desc">Obtener todos los exámenes</div>
                    </div>
                    <div class="endpoint">
                        <span class="endpoint-method method-post">POST</span>
                        <span class="endpoint-url">/examenes</span>
                ...
                <div class="card">
                    ...
                    <div class="endpoint">
                        ...
                        <div class="endpoint-desc">Guardar calificación</div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="endpoint">
                        ...
                        <div class="endpoint-desc">Obtener todos los módulos</div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="endpoint">
                        ...
                        <div class="endpoint-desc">Documentación Swagger</div>
                    </div>
                    <div class="endpoint">
                        <span class="endpoint-method method-get">GET</span>
                        <span class="endpoint-url">/openapi.json</span>
                        <div class="endpoint-desc">Especificación OpenAPI</div>
                    </div>
                </div>
            </div>
